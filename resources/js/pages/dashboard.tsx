...
interface ExamDistributionItem {
    status: string;
    value: number;
}
...
export default function Dashboard() {
    ...
    if (role === 'student' && studentData) {
        ...
        const distributionTotal =
            examDistribution.reduce((acc, d) => acc + d.value, 0) || 1;
        const areaData = [
            {
                name: 'Exams',
                Available: examStats.available,
                                        ...
                                        >
                                            <div className="flex items-center gap-2">
                                                <span
                                                    ...
                                                    style={{
                                                        background: `var(--color-chart-${idx + 1})`,
                                                    }}
                                                />
                                                <span>{d.status}</span>
                                            </div>
                            ...
                            <CardContent className="flex-1 overflow-auto">
                                ...
                                <ul className="space-y-3">
                                    {units.map((u) => (
                                        <li
                                            key={u.id}
                                            className="flex flex-col gap-1 rounded border bg-muted/40 p-3"
                                        >
    ...
    if (role === 'teacher' && teacherData) {
        ...
        const combinedByUnit = new Map<
            string,
            { unit: string; students: number; exams: number }
        >();
        charts.studentsPerUnit.forEach((s) => {
            combinedByUnit.set(s.unit, {
                unit: s.unit,
                students: s.students,
                exams: 0,
            });
            ...
            <AppLayout breadcrumbs={breadcrumbs}>
                ...
                <div className="flex h-full flex-1 flex-col gap-4 overflow-x-hidden rounded-xl p-4">
                    ...
                    <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                        ...
                        <Card>
                            <CardHeader>
                                <CardTitle>Active Exams (Today)</CardTitle>
                            </CardHeader>
                            <CardContent>
                                <span className="text-3xl font-bold">
                                    {cards.activeExamsToday}
                                </span>
                            </CardContent>
                        </Card>
                        <Card>
                    ...
                    <div className="grid gap-4 md:grid-cols-2">
                        <Card>
                            <CardHeader>
                                <CardTitle>Students per Unit</CardTitle>
                            </CardHeader>
                            <CardContent>
                                <ChartContainer
                                    config={{
                        ...
                        <Card>
                            <CardHeader>
                                <CardTitle>Students & Exams</CardTitle>
                            </CardHeader>
                            <CardContent>
                                <ChartContainer
                                    config={{
                    ...
                    {/* Students table */}
                    <div className="relative flex-1 overflow-hidden rounded-xl border border-sidebar-border/70 bg-card md:min-h-min dark:border-sidebar-border">
                        <Table>
                            <TableHeader>
                                <TableRow>
