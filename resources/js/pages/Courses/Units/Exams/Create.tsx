...
interface ExamsCreateProps extends PageProps {
    course: Course;
    unit: Unit;
}
...
export default function Create({ auth, course, unit }: ExamsCreateProps) {
    ...
    return (
        <AuthenticatedLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Create Exam for: {unit.title}</h2>}
        >
            ...
            <div className="py-12">
                <div className="max-w-3xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                        <h3 className="text-lg font-medium text-gray-900 mb-4">Course: {course.name}</h3>
